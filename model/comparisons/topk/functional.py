...
from model.comparisons.topk.polynomial.sp import log_sum_exp, LogSumExp
from model.comparisons.topk.logarithm import LogTensor
from model.comparisons.topk.utils import delta, split
...
def Topk_Hard_SVM(labels, k, alpha=1.0):
    def fun(x, y):
...
def Topk_Smooth_SVM(labels, k, tau, alpha=1.0):
