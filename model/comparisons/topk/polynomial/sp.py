...
from model.comparisons.topk.polynomial.divide_conquer import divide_and_conquer
from model.comparisons.topk.polynomial.multiplication import Multiplication
from model.comparisons.topk.polynomial.grad import d_logS_d_expX
...
class LogSumExp_F(ag.Function):
    ...
    def backward(self, grad_sk):
        ...
        self.grad_km1 = d_logS_d_expX(
            S, X, self.k - 1, self.p, self.grad_km1, self.thresh
        )
